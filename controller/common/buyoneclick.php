...
class ControllerCommonBuyoneclick extends Controller {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/common/buyoneclick.tpl')) {
			return $this->load->view($this->config->get('config_template') . '/template/common/buyoneclick.tpl', $data);
		} else {
			return $this->load->view('default/template/common/buyoneclick.tpl', $data);
		}
	}
