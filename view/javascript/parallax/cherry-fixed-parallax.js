    ...
    var methods = {
        init : function( options ) {
            ...
            return this.each(function(){
                ...
                var 
                    $this = $(this)
                ,   windowContainerSelector = $('.container')     
                ...
                function _constructor(){
                    ...
                    if(settings.bgfixed){
                        $this.css({'background-attachment': 'auto'});
                    }
                ...
                function addEventsFunction(){
                    ...
                    windowSelector.on("resize",
                        function(){
                            $this.width(windowContainerSelector.width());
                            $this.css({'width' : windowContainerSelector.width(), 'margin-left' : Math.floor(windowContainerSelector.width()*-0.5), 'left' : '50%'});
