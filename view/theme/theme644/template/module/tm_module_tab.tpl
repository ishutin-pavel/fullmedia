...
<div role="tabpanel" class="module_tab module_tab__<?php echo $module?>">
  ...
  <div class="tab-content">
    ...
    <div role="tabpanel" class="tab-pane" id="tab-latest-<?php echo $module; ?>">
      <div class="row">
        <?php $tl = 6000; foreach ($latest_products as $product) { $tl++ ?>
              ...
              <div>
                ...
                <div class="right col-sm-8">
                  ...
                  <div class="rating">
                    ...
                    <span class="fa-stack"><i class="fl-justicons-favorites2 fa-stack-1x"></i></span>
                    <?php } else { ?>
                    <span class="fa-stack"><i class="fl-justicons-favorites2 fa-stack-1x"></i>
                      <i class="fl-justicons-favorites2 star  fa-stack-1x"></i>
                    </span>
                    <?php } ?>
                    <?php } ?>
                  </div>
    ...
    <div role="tabpanel" class="tab-pane" id="tab-featured-<?php echo $module; ?>">
      <div class="row">
        <?php $tf = 5000; foreach ($featured_products as $product) { $tf++ ?>
        <div class="product-layout col-lg-3 col-md-3 col-sm-3 col-xs-12">
        <div class="product-thumb transition <?php if ($product['options']) echo 'options';?>">
          <?php if ($product['options']) { ?>
            ...
            <div id="quickview_featured_<?php echo $tf . $module ?>" class="quickview-style">
              <div>
                ...
                <div class="right col-sm-8">
                  ...
                  <button class="product-btn-add" data-toggle="tooltip" title="<?php echo $button_cart; ?>" type="button" onclick="cart.add('<?php echo $product['product_id']; ?>');">В корзину <i class="fl-justicons-shopping189"></i></button>
                  <div class="clear"></div>
                </div>
                <div class="col-sm-12">
                  <div class="quickview_description description">
    ...
    <div role="tabpanel" class="tab-pane" id="tab-specials-<?php echo $module; ?>">
      <div class="row">
        <?php $ts = 7000; foreach ($special_products as $product) { $ts++ ?>
        <div class="product-layout col-lg-3 col-md-3 col-sm-3 col-xs-12">
        <div class="product-thumb transition <?php if ($product['options']) echo 'options';?>">
          <?php if ($product['options']) { ?>
    ...
    <div role="tabpanel" class="tab-pane" id="tab-bestsellers-<?php echo $module; ?>">
      <div class="row">
        <?php $tb = 8000; foreach ($bestseller_products as $product) { $tb++ ?>
        <div class="product-layout col-lg-3 col-md-3 col-sm-3 col-xs-12">
        <div class="product-thumb transition <?php if ($product['options']) echo 'options';?>">
          <?php if ($product['options']) { ?>
