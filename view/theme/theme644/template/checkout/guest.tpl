  ...
  <div class="col-sm-6">
    <fieldset id="account">
      ...
      <div class="form-group required" style="display:none;">
        ...
        <input type="text" name="lastname" value="hidden" placeholder="<?php echo $entry_lastname; ?>" id="input-payment-lastname" class="form-control" />
      </div>
      <div class="form-group required">
      ...
      <div class="form-group" style="display:none;">
        ...
        <input type="text" name="fax" value="hidden" placeholder="<?php echo $entry_fax; ?>" id="input-payment-fax" class="form-control" />
      </div>
  ...
  <div class="col-sm-6">
    <fieldset id="address">
      ...
      <div class="form-group required" style="display: none;">
        ...
        <input type="text" name="city" value="hidden" placeholder="<?php echo $entry_city; ?>" id="input-payment-city" class="form-control" />
      </div>
      <div class="form-group required" style="display: none;">
      ...
      <div class="form-group required" style="display:none;">
        ...
        <input type="text" value="2721" name="zone_id" id="input-payment-zone" class="form-control">
      </div>
      <?php foreach ($custom_fields as $custom_field) { ?>
